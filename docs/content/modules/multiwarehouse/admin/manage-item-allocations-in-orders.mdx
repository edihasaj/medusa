...
```tsx
import { useAdminReservations } from "@applifyer/medusa-react"
...
```tsx
import { useAdminReservation } from "@applifyer/medusa-react"
...
```tsx
import { useAdminUpdateReservation } from "@applifyer/medusa-react"
...
```tsx
import { useAdminRequestReturn } from "@applifyer/medusa-react"
