...
```tsx
import { useAdminCreateStockLocation } from "@applifyer/medusa-react"
...
```tsx
import { useAdminStockLocation } from "@applifyer/medusa-react"
...
```tsx
import { useAdminAddLocationToSalesChannel } from "@applifyer/medusa-react"
