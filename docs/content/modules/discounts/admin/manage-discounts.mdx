...
```tsx
import { useAdminDiscountCreateCondition } from "@applifyer/medusa-react"
import { DiscountConditionOperator } from "@applifyer/medusa"
...
```tsx
import { useAdminDiscountUpdateCondition } from "@applifyer/medusa-react"
import { Product } from "@applifyer/medusa"
...
```tsx
import { useAdminDiscountRemoveCondition } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteDiscount } from "@applifyer/medusa-react"
