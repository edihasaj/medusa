...
```tsx
import { useAdminSalesChannel } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteSalesChannel } from "@applifyer/medusa-react"
...
```tsx
import { useAdminAddProductsToSalesChannel } from "@applifyer/medusa-react"
