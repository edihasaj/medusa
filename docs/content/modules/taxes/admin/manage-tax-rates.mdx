...
```tsx
import { useAdminTaxRates } from "@applifyer/medusa-react"
...
```tsx
import { useAdminUpdateTaxRate } from "@applifyer/medusa-react"
...
```tsx
import { useAdminCreateProductTaxRates } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteProductTaxRates } from "@applifyer/medusa-react"
...
```tsx
import { useAdminCreateShippingTaxRates } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteShippingTaxRates } from "@applifyer/medusa-react"
