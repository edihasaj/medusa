...
```tsx
import { useCreateCustomer } from "@applifyer/medusa-react"
...
```tsx
import { useUpdateMe } from "@applifyer/medusa-react"
...
```tsx
import { useCustomerOrders } from "@applifyer/medusa-react"
