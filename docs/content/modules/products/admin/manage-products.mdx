...
```tsx
import { useAdminCreateProductOption } from "@applifyer/medusa-react"
...
```tsx
import { useAdminUpdateProductOption } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteProductOption } from "@applifyer/medusa-react"
...
```tsx
import { useAdminCreateVariant } from "@applifyer/medusa-react"
...
```tsx
import { useAdminUpdateVariant } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteVariant } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteProduct } from "@applifyer/medusa-react"
