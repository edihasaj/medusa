...
import { useAdminCurrencies } from "@applifyer/medusa-react"
...
```tsx
import { useAdminUpdateCurrency } from "@applifyer/medusa-react"
...
```tsx
import { useAdminAddStoreCurrency } from "@applifyer/medusa-react"
...
```tsx
import { useAdminDeleteStoreCurrency } from "@applifyer/medusa-react"
